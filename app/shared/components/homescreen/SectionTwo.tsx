        ...
        <div className="w-[50%] grid items-center">
            <div className="h-[50%] w-full flex flex-col justify-center items-center p-4">
                <div className="px-4 w-full flex flex-col gap-2">
                    <h1 className="text-3xl font-bold">تشكيلة الرجال: تميز وثقة</h1>
                    <div>
                        <p className="text-1xl">للرجل الذي يقدر الجودة والتفاصيل. نقدم لك مجموعة من الإكسسوارات والهدايا الرجالية التي تجمع بين التصميم العصري واللمسة الكلاسيكية الخالدة، لتعبر عن ذوقك الرفيع.</p>
                    </div>
                </div>
