        ...
        <div className="w-[50%] grid items-center">
            <div className="h-[50%] w-full flex flex-col justify-center items-center p-4">
                <div className="px-4 w-full flex flex-col gap-2">
                    <h1 className="text-3xl font-bold">تشكيلة الأطفال: سحر وابتسامة</h1>
                    <div>
                        <p className="text-1xl">اجعل لحظاتهم مميزة مع قطعنا المصممة بحب للأطفال. إكسسوارات آمنة وجذابة لتضيف لمسة من السحر على إطلالتهم اليومية أو مناسباتهم الخاصة.
                        </p>
                    </div>
                </div>
            </div>
